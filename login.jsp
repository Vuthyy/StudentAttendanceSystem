    ...
    <script>
      ...
      function togglePassword() {
        ...
        if (passwordField.type === "password") {
          ...
          eyeIcon.src = "https://img.icons8.com/ios-filled/50/000000/visible.png"; // Change to open eye icon
        } else {
          passwordField.type = "password"; // Hide password
          eyeIcon.src = "https://img.icons8.com/ios-filled/50/000000/invisible.png"; // Change to closed eye icon
        }
      }
    </script>
  </head>
              ...
              <form action="login.jsp" method="POST" class="space-y-4">
                ...
                <div>
                  ...
                  <div class="relative flex items-center">
                    ...
                    <img id="eye-icon" src="https://img.icons8.com/ios-filled/50/000000/invisible.png" alt="Toggle Visibility" class="w-[18px] h-[18px] absolute right-4 cursor-pointer" onclick="togglePassword()" />
                  </div>
                </div>
                ...
                <p class="text-sm !mt-8 text-center text-gray-800">Don't have an account <a href="signup.jsp" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
              </form>
            </div>
            ...
            try (Connection conn = DBConnection.getConnection()) {
                if (conn != null) {
                    ...
                    if (rs.next()) {
                        ...
                        response.sendRedirect("dashboard.jsp?username=" + username); // Redirecting with username
                    } else {
                        // Invalid username/password, show error
                        out.println("<p class='text-center text-red-500 font-semibold'>Invalid username or password.</p>");
                    }
                } else {
                    out.println("<p class='text-center text-red-500 font-semibold'>Database connection failed.</p>");
                }
            } catch (SQLException e) {
                e.printStackTrace();
                out.println("<p class='text-center text-red-500 font-semibold'>Error: " + e.getMessage() + "</p>");
            }
        }
    %>
  </body>
